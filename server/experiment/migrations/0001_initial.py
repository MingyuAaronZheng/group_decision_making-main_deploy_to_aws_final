# Generated by Django 3.2.13 on 2025-07-19 11:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='NormalDemographicSurveyResponse',
            fields=[
                ('_id', models.AutoField(auto_created=True, primary_key=True, serialize=False)),
                ('subject_id', models.IntegerField(default=None)),
                ...
                ('ethnicity_selection', models.CharField(max_length=255)),
                ('religion_affiliation', models.CharField(max_length=255)),
                ('political_affiliation', models.CharField(max_length=255)),
                ('immigration_status', models.CharField(blank=True, max_length=255, null=True)),
